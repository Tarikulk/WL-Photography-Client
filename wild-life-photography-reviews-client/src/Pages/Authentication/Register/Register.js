...
const Register = () => {
	...
	<form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
		<div className="space-y-1 text-sm">
			...
			<input type="text" name="username" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 text-whit focus:dark:border-violet-400" />
		</div>
		<div className="space-y-1 text-sm">
